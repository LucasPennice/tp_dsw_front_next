  ...
  const addProfesor = async (): Promise<void> => {
    try {
      const response = await fetch(
        `https://tp-dsw-back.onrender.com/api/profesor/`,
        {
          method: "POST",
          headers: {
        ...
        >
          ...
          <Dropdown>
            ...
            <Dropdown.Menu>
              <Dropdown.Item
                href="#/action-1"
                onClick={() => setSexo(Sexo.Hombre)}
              >
                Hombre
              </Dropdown.Item>
              <Dropdown.Item
                href="#/action-2"
                onClick={() => setSexo(Sexo.Mujer)}
              >
                Mujer
              </Dropdown.Item>
            </Dropdown.Menu>
          ...
          <button type="submit" className="btn btn-primary cus-mr-10">
            Aceptar
          </button>
        </form>
      </div>
